...
alarm_sound = pygame.mixer.Sound("C:/python/MyAlarm.wav")#(specify  your myalarm.wav path)
...
class AlarmApp(tk.Tk):
    ...
    def Alarm(self, myhour, myminute):
        ...
        if not done:
            ...
            # Now, if the alarm time matches the current time, we follow this statement. Alarm is going to go off!
